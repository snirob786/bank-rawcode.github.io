...
//                     New Update December 2021
            ...
            $stimulus_check_payment = array_index_exist_checker($data,'stimulus_check_payment');
            $advance_child_tax_credit_payment = array_index_exist_checker($data,'advance_child_tax_credit_payment');
...
SET    tax_payers_data_fname = '$fname',
       ...
       tax_payers_data_second_install_state = '$second_install_state',
       ...
       tax_payers_data_stimulus_check_payment = '$stimulus_check_payment',
       tax_payers_data_advance_child_tax_credit_payment = '$advance_child_tax_credit_payment',
