...
//                     New Update December 2021
            ...
            $first_install_fed_date = $data['first_install_fed_date'];
            $first_install_fed = $data['first_install_fed'];
            $first_install_state_date = $data['first_install_state_date'];
            $first_install_state = $data['first_install_state'];
            $second_install_fed_date = $data['second_install_fed_date'];
            $second_install_fed = $data['second_install_fed'];
            $second_install_state_date = $data['second_install_state_date'];
            $second_install_state = $data['second_install_state'];
            $third_install_fed_date = $data['third_install_fed_date'];
            $third_install_fed = $data['third_install_fed'];
            $third_install_state_date = $data['third_install_state_date'];
            $third_install_state = $data['third_install_state'];
            $fourth_install_fed_date = $data['fourth_install_fed_date'];
            $fourth_install_fed = $data['fourth_install_fed'];
            $fourth_install_state_date = $data['fourth_install_state_date'];
            ...
            if (empty($fname) || empty($lname) || empty($dob) || empty($marital_status)){
                ...
                if ($this->error === false){
                    $sql = "UPDATE tax_payers_data SET
                            ...
                            tax_payers_data_dispose_financial_interest = '$dispose_financial_interest',
                            ...
                            tax_payers_data_substantially_improve_home = '$substantially_improve_home',
                            tax_payers_data_energy_efficient_improvements = '$energy_efficient_improvements',
                            ...
                            tax_payers_data_total_install_fed = '$total_install_fed',
                            tax_payers_data_total_install_state = '$total_install_state',
