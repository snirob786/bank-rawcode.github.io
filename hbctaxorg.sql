...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 11, 2022 at 10:14 PM
...
CREATE TABLE `tax_payers_data` (
  ...
  `tax_payers_data_additional_note` longtext DEFAULT NULL,
  ...
  `tax_payers_data_stimulus_check_payment` varchar(45) DEFAULT NULL,
  `tax_payers_data_advance_child_tax_credit_payment` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, 'Arshaan', 'Son', '2021-01-01', '1234567', '12', 'no', 'yes', '123456789', '2022-02-08 20:28:23', '61e047b884e60', '321', '1000'),
(2, 'Dependand 2', 'Son', '2021-01-01', '12345', '12', 'no', 'no', '123456789', '2022-02-08 20:28:23', '61e18b46f066b', '1234', '1000'),
(3, 'Wamia Iqbal', 'Daughter', '2009-12-03', '123859630', '12', 'no', 'no', '94841385', '2022-01-18 23:16:40', '61e748ed235a6', '036985', ''),
(4, 'Mehrish', 'Son', '2012-04-18', '123569870', '12', 'no', 'no', '94841385', '2022-01-18 23:16:40', '61e74a58ecbbf', '', '');
...
--
ALTER TABLE `tax_payers_dependants_data`
  MODIFY `idtax_payers_dependants_data_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
COMMIT;
