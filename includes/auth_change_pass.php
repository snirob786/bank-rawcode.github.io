<?php
    ...
    $status = $admin->change_password($_POST);
    ...
    } else if($status === 'user_updated'){
        echo json_encode(['success' => 'inserted','message' => 'Data updated successfully']);
    }else if($status === 'confirm_pass_mismatch'){
        echo json_encode(['success' => 'error','message' => 'Confirm password mismatch with new password']);
    }
